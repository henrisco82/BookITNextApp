...
import { Search, Users, Clock, Calendar, ArrowRight, LogOut, Home } from 'lucide-react'
    ...
    useEffect(() => {
        const fetchProviders = async () => {
            try {
                ...
                const providerList = snapshot.docs.map((doc) => doc.data())
                ...
                {isLoading ? (
                    ...
                    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                        {filteredProviders.map((provider) => (
                            <Card key={provider.id} className="border-2 hover:border-primary/50 transition-colors">
                                <CardHeader>
