...
export function PortfolioManager() {
    ...
    useEffect(() => {
        ...
        const fetchPortfolio = async () => {
            try {
                // Determine query. Note: simple query first to avoid index requirements
                const q = query(
                    portfolioCollection,
                ...
                const portfolioItems = snapshot.docs.map(doc => doc.data())
                                            ...
                                            {previewUrl ? (
                                                <div className="relative">
                                                    <img
                                                        src={previewUrl}
                                                        alt="Preview"
                                                        className="rounded-md max-h-48 mx-auto object-cover"
                                                    />
                                                    <Button
                                                        type="button"
                                                        variant="destructive"
